...
@MapperScan(basePackages = "com.example.sml.mapper.base1",
...
public class WMyBatisConfig {
    ...
    public SqlSessionFactory wSqlSessionFactory()
        ...
        sessionFactory.setTypeAliasesPackage("com.example.sml.entity");
        // 指定主库对应的mapper.xml文件
        sessionFactory.setMapperLocations(new PathMatchingResourcePatternResolver()
                .getResources("classpath:mapper/base1/*.xml"));
